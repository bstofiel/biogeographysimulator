...
class IslandsControllerTest < ActionController::TestCase
  ...
  test "should create island" do
    assert_difference('Island.count') do
      post :create, island: { distance: @island.distance, length: @island.length, name: @island.name, project_id: @island.project_id, width: @island.width }
    end
  ...
  test "should update island" do
    patch :update, id: @island, island: { distance: @island.distance, length: @island.length, name: @island.name, project_id: @island.project_id, width: @island.width }
    assert_redirected_to island_path(assigns(:island))
  end
